...
** OCL + EOL all
#+name: agg-query-all-both-2019
| size |       |      |        |       |      |      |        |       |       |      |       |     |     |     |     |     |       |     |        |      |      |      |        |       |
|------+-------+------+--------+-------+------+------+--------+-------+-------+------+-------+-----+-----+-----+-----+-----+-------+-----+--------+------+------+------+--------+-------|
|  10^1 |  618. |  10. |   658. |   40. |  0.9 |  0.5 |     3. |    3. |  609. |  11. |  649. | 41. |  3. |  3. |  2. |  2. |   632 | 10. |   667. |  41. |   1. |   1. |     2. |    4. |
|  10^2 |   614 |   10 |   661. |   41. |  0.7 |  0.5 |     3. |     2 |  610. |  11. |  652. |  41 |  2. |  2. |  2. |  2. |  626. | 10. |   673. |   41 |    1 |   1. |     3. |    3. |
|  10^3 |  623. |  10. |   694. |   44. |    1 |    1 |    13. |    3. |  616. |  11. |  667. | 41. |  1. |  1. |  2. |  3. |   619 | 11. |   693. |  43. |   2. |   1. |    14. |    4. |
|  10^4 |  675. |  12. |   859. |   57. |   6. |   6. |   131. |   17. |  668. |  10. |  853. | 42. |  2. |  2. |   2 |  2. |  672. | 14. |   875. |  86. |   6. |   6. |   139. |    18 |
|  10^5 | 1235. |  63. |   2729 |  227. |  70. |  70. |  1330. |  176. | 1167. |  35. | 2587. | 42. |  2. |  2. |  2. |  3. | 1212. | 66. |  2635. | 268. |  70. |  71. |  1371. |  177. |
|  10^6 | 6643. | 753. | 19875. | 2188. | 700. | 693. | 12986. | 1851. | 6277. | 272. | 19789 | 61. | 15. | 16. | 14. | 14. | 6744. | 709 | 20653. | 2651 | 702. | 689. | 13244. | 1822. |
#+TBLFM: @2$2..@>$9=remote(agg-query0-both-2019, @@#$$#)
#+TBLFM: @2$10..@>$17=remote(agg-query1-both-2019, @@#$$#)
#+TBLFM: @2$18..@>$25=remote(agg-query2-both-2019, @@#$$#)

#+begin_src gnuplot :var data=agg-query-all-both-2019 :file images/bench-query-all-both-2019.pdf
...
# Colorblind-safe palette
set style line 1 lc rgb "#d55e00"
set style line 2 lc rgb "#e69f00"
set style line 3 lc rgb "#56b4e9"
set style line 4 lc rgb "#0072b2"
...
plot newhistogram "",\
       data u 2:xticlabels(1) notitle fs pattern 0, '' u 3:xticlabels(1) notitle fs pattern 4,\
       data u 6:xticlabels(1) notitle fs pattern 2,\
     newhistogram "" lt 1,\
       ''   u 4:xticlabels(1) ti 'OCL' fs pattern 0, '' u 5:xticlabels(1) ti 'OCL (Opt.)' fs pattern 4,\
       ''   u 8:xticlabels(1) ti 'EOL' fs pattern 2, '' u 9:xticlabels(1) ti 'EOL (Opt.)' fs solid 0.2
...
plot newhistogram "",\
       data u 10:xticlabels(1) notitle fs pattern 0, '' u 11:xticlabels(1) notitle fs pattern 4,\
       data u 14:xticlabels(1) notitle fs pattern 2,\
     newhistogram "" lt 1,\
       ''   u 12:xticlabels(1) ti 'OCL' fs pattern 0, '' u 13:xticlabels(1) ti 'OCL (Opt.)' fs pattern 4,\
       ''   u 16:xticlabels(1) ti 'EOL' fs pattern 2, '' u 17:xticlabels(1) ti 'EOL (Opt.)' fs solid 0.2
...
plot newhistogram "XMI",\
       data u 18:xticlabels(1) notitle fs pattern 0, '' u 19:xticlabels(1) notitle fs pattern 4,\
       data u 22:xticlabels(1) notitle fs pattern 2,\
     newhistogram "Heterogeneous" lt 1,\
       ''   u 20:xticlabels(1) ti 'OCL' fs pattern 0, '' u 21:xticlabels(1) ti 'OCL (Opt.)' fs pattern 4,\
       ''   u 24:xticlabels(1) ti 'EOL' fs pattern 2, '' u 25:xticlabels(1) ti 'EOL (Opt.)' fs solid 0.2
...
#+begin_src gnuplot :var data=agg-query-all-both-2019 :file images/bench-query-all-both-lines-2019.pdf
set terminal pdf enhanced size 12cm,15cm font "serif,11" color

unset title
set key outside at screen 0.30,0.88

set xtics scale 0 offset 0,0.3,0
set ylabel 'time (ms)' offset 0,-13,0
set xrange [0.5:6.5]
set yrange [0.5:80000]
set logscale y
set grid y

set style line 1 lc rgb '#d7191c' pt 8
set style line 2 lc rgb '#d7191c' pt 9
set style line 3 lc rgb '#fd8e41' pt 2
set style line 4 lc rgb '#9bdd94' pt 4
set style line 5 lc rgb '#9bdd94' pt 5
set style line 6 lc rgb '#2b83ba' pt 6
set style line 7 lc rgb '#2b83ba' pt 7
...
plot data u 1:2 ti 'XMI OCL           '     w lp ls 1,\
       '' u 1:3 ti 'XMI OCL (Opt.)'         w lp ls 2,\
       '' u 1:6 ti 'XMI EOL           '     w lp ls 3,\
       '' u 1:4 ti 'Hetero. OCL           ' w lp ls 4,\
       '' u 1:5 ti 'Hetero. OCL (Opt.)'     w lp ls 5,\
       '' u 1:8 ti 'Hetero. EOL           ' w lp ls 6,\
       '' u 1:9 ti 'Hetero. EOL (Opt.)'     w lp ls 7
...
plot data u 1:10 ti 'XMI OCL'           w lp ls 1,\
       '' u 1:11 ti 'XMI OCL (Opt.)'    w lp ls 2,\
       '' u 1:14 ti 'XMI EOL'           w lp ls 3,\
       '' u 1:12 ti 'Hetero OCL'        w lp ls 4,\
       '' u 1:13 ti 'Hetero OCL (Opt.)' w lp ls 5,\
       '' u 1:16 ti 'Hetero EOL'        w lp ls 6,\
       '' u 1:17 ti 'Hetero EOL (Opt.)' w lp ls 7
...
plot data u 1:18 ti 'XMI OCL'           w lp ls 1,\
       '' u 1:19 ti 'XMI OCL (Opt.)'    w lp ls 2,\
       '' u 1:22 ti 'XMI EOL'           w lp ls 3,\
       '' u 1:20 ti 'Hetero OCL'        w lp ls 4,\
       '' u 1:21 ti 'Hetero OCL (Opt.)' w lp ls 5,\
       '' u 1:24 ti 'Hetero EOL'        w lp ls 6,\
       '' u 1:25 ti 'Hetero EOL (Opt.)' w lp ls 7

unset multiplot
#+end_src

#+RESULTS:
[[file:images/bench-query-all-both-lines-2019.pdf]]

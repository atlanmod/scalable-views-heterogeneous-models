...
#+begin_src gnuplot :var data=agg-query0-both-2019 :file images/bench-query0-both-2019.png
set terminal png size 800,400 font "serif,9"
...
#+RESULTS:
[[file:images/bench-query0-both-2019.png]]
...
#+begin_src gnuplot :var data=agg-query1-both-2019 :file images/bench-query1-both-2019.png
set terminal png size 800,400 font "serif,9"
...
#+RESULTS:
[[file:images/bench-query1-both-2019.png]]
...
#+begin_src gnuplot :var data=agg-query2-both-2019 :file images/bench-query2-both-2019.png
set terminal png size 800,400 font "serif,9"
...
#+RESULTS:
[[file:images/bench-query2-both-2019.png]]

...
plot newhistogram "",\
       ...
       data u 6:xticlabels(1) notitle fs pattern 5,\
     newhistogram "" lt 1,\
       ''   u 4:xticlabels(1) ti 'OCL' fs pattern 4, '' u 5:xticlabels(1) ti 'OCL (Opt.)' fs pattern 6,\
       ''   u 8:xticlabels(1) ti 'EOL' fs pattern 5, '' u 9:xticlabels(1) ti 'EOL (Opt.)' fs pattern 7
...
plot newhistogram "",\
       data u 10:xticlabels(1) notitle fs pattern 4, '' u 11:xticlabels(1) notitle fs pattern 6,\
       data u 14:xticlabels(1) notitle fs pattern 5,\
     newhistogram "" lt 1,\
       ''   u 12:xticlabels(1) ti 'OCL' fs pattern 4, '' u 13:xticlabels(1) ti 'OCL (Opt.)' fs pattern 6,\
       ''   u 16:xticlabels(1) ti 'EOL' fs pattern 5, '' u 17:xticlabels(1) ti 'EOL (Opt.)' fs pattern 7
...
plot newhistogram "XMI",\
       data u 18:xticlabels(1) notitle fs pattern 4, '' u 19:xticlabels(1) notitle fs pattern 6,\
       data u 22:xticlabels(1) notitle fs pattern 5,\
     newhistogram "Heterogeneous" lt 1,\
       ''   u 20:xticlabels(1) ti 'OCL' fs pattern 4, '' u 21:xticlabels(1) ti 'OCL (Opt.)' fs pattern 6,\
       ''   u 24:xticlabels(1) ti 'EOL' fs pattern 5, '' u 25:xticlabels(1) ti 'EOL (Opt.)' fs pattern 7
